...
Gliadins are broadly divided into three types: $$\alpha$$/$$\beta$$-, $$\gamma$$-, and ω-gliadins. The distribution of these types varies according to the wheat genotype and growing conditions, such as climate, soil, and fertilization. Among them, $$\alpha$$/$$\beta$$- and $$\gamma$$-gliadins are the major components compared to ω-gliadins.
