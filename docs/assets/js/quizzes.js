function VerifyAnswer(correctAnswer, formID) {
    ...
    document.getElementById(correctAnswer).nextSibling.nextSibling.innerHTML += " <span class=\"quizIndicatorCorrect\">󰸞</span>";
    if (answer != correctAnswer) {
        document.getElementById(answer).nextSibling.nextSibling.innerHTML += "  <span class=\"quizIndicatorWrong\"></span>";
    }
}
